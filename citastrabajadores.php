  ...
  <body>
      ...
      <div class="container">
        <div class="row justify-content-center align-items-center">
          <div class="col-lg-9 text-center mt-5">
            <h1 class="heading" data-aos="fade-up">Bienvenid@ <?php echo $_SESSION["nombrep"] ?></h1>
    ...
    <div class="section">
      ...
      <table border=1px width=100% >
        ...
        $idp = "SELECT id from trabajadores where nombre = '$nombrep'";
        

        $sql = "select t.id, c.* from citas c, trabajadores t where t.nombre = '$nombrep' and t.id = c.idProfesional";

        $result = $conn->query($sql);
        while($row = $result->fetch_assoc()) {
            echo "<tr >";echo "<br>";
            if (isset($_GET['id']) && ($row['id'] == $_GET['id'])) {
              echo '<form class="form-inline m-2" action="update-trabaja.php" method="POST">';
            ...
            echo '<td><a class="btn2 btn-primary" href="citastrabajadores.php?id=' . $row['id'] . '" role="button">Update</a></td>';
            echo '<td><a class="btn2 btn-danger" href="delete-trabaja.php?id=' . $row['id'] . '" role="button">Delete</a></td>';
            echo "</tr>";
          }
