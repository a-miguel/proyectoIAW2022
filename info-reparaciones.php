        ...
        <div class="row justify-content-center align-items-center">
          <div class="col-lg-9 text-center mt-5">
            <h1 class="heading" data-aos="fade-up">
              Información de las reparaciones
            </h1>
            ...
            >
              <ol class="breadcrumb text-center justify-content-center">
                ...
                <li class="breadcrumb-item">
                  <a href="todo-reparar.php">Más Reparaciones</a>
                </li>
                <li
    ...
    <div class="section">
      <div class="container">
        <div class="row justify-content-between">
          ...
          <div class="col-lg-4">
            <h2 class="heading text-primary">Información de las reparaciones</h2>
            <p class="meta">P. Sherman, calle Wallaby, 42, Sydney</p>
            ...
            <div class="d-block agent-box p-5">
              ...
              <div class="text">
                <h3 class="mb-0">Synthia Cameron</h3>
                <div class="meta mb-3">Tecnica en reparaciones de consolas</div>
                <p>
